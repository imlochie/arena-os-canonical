...
export const CAMERAS: Camera[] = [
  {
    ...
    family: 'Digital',
    lookIds: ['digi', 'digi-warm', 'digi-flash'],
    defaultLookId: 'digi',
  ...
  },
  {
    ...
    family: 'Clean',
    lookIds: ['clean', 'clean-warm', 'clean-soft'],
    defaultLookId: 'clean',
  ...
  },
  {
    ...
    family: 'Film',
    lookIds: ['warm-film', 'soft-film', 'faded-film'],
    defaultLookId: 'warm-film',
  ...
  },
  {
    ...
    family: 'Black & White',
    lookIds: ['bw-classic', 'bw-high-contrast'],
    defaultLookId: 'bw-classic',
  ...
  },
  {
    ...
    tagline: 'After dark',
    family: 'Night',
    lookIds: ['night-flash', 'night-grain'],
    defaultLookId: 'night-flash',
