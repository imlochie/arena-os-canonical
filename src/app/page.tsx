    ...
    <div>
      <section className="mb-6 text-center">
        ...
        <div className="mx-auto mt-4 flex max-w-2xl flex-wrap items-center justify-center gap-2 text-[11px] font-bold">
          ...
          <a href="/cut" className="rounded-full bg-fuchsia-500/20 px-3.5 py-1.5 text-fuchsia-200 ring-1 ring-fuchsia-400/40 hover:bg-fuchsia-500/30">
            ✂️ New: Cut Lab — trim & export your generations →
          </a>
