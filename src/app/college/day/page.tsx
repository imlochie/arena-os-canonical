...
const EVENT_STYLE: Record<string, { color: string; glyph: string }> = {
  ...
  faculty_silent: { color: "#475569", glyph: "·" },
  faculty_interruption_requested: { color: "#fb923c", glyph: "!" },
  faculty_interruption_accepted: { color: "#f97316", glyph: "!!" },
  faculty_interruption_rejected: { color: "#64748b", glyph: "✕" },
  memory_recalled: { color: "#a78bfa", glyph: "◇" },
  real_world_context_added: { color: "#f97316", glyph: "⚡" },
  record_proposed: { color: "#818cf8", glyph: "▸" },
  record_filed: { color: "#818cf8", glyph: "▪" },
